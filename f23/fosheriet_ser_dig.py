...
def clean_fohsare(driver: Driver, data):
    ...
    if reaction["emoji_name"] == "fohserietserdig" and \
        reaction["user_id"] not in ("nwdqsc3ifjbybrxppxxdsf6d9w", "mqo9aogurbn75x4sjk53soiwzc", "snbz4s3zt3b6tezxm1mz77uwor"):
...
def clean_message(driver: Driver, data):
    ...
    if ":fohserietserdig:" in post["message"] and \
        post["user_id"] not in ("nwdqsc3ifjbybrxppxxdsf6d9w", "mqo9aogurbn75x4sjk53soiwzc", "snbz4s3zt3b6tezxm1mz77uwor"):
